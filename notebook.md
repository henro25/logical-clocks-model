...
- **Smaller jumps overall:**  
  ...
  ![ Alt Text](./CustomVariationAnalysis/Aggregated_Max_Clock_Jump_Custom.png)
- **Lower average drift:**  
  ...
  ![ Alt Text](./CustomVariationAnalysis/Aggregated_Max_Drift_Custom.png)
