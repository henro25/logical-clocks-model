...
- **Lower average and terminating drift:**  
  ...
  ![ Alt Text](./CustomVariationAnalysis/Aggregated_Term_Avg_Drift_Custom.png)
...
- **Drift behavior:**
  ...
  ![ Alt Text](./LogicalClockAnalysisImages/Aggregated_Term_Avg_Drift.png)
